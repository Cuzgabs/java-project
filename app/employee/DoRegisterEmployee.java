  ...
  protected void execute() throws CommandException {
    ...
    try {
      ...
      if (employeeType.equals("VET")) {
        _receiver.registerVeterinario(employeeId, employeeName, employeeType, new ArrayList<>(0));  // Sem responsabilidades iniciais
      } else if (employeeType.equals("TRT")) {
        _receiver.registerTratador(employeeId, employeeName, employeeType, new ArrayList<>(0));  // Sem responsabilidades iniciais
      }
