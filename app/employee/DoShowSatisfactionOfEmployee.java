...
import hva.core.KeeperSatisfactionFormula;
import hva.core.VetSatisfactionFormula;
...
class DoShowSatisfactionOfEmployee extends Command<Hotel> {
  ...
  protected void execute() throws CommandException {
    ...
    try {
      ...
      employee.setSatisfactionStrategy(employee.getEmployeeType()
      .equalsIgnoreCase("TRT") ? new KeeperSatisfactionFormula() : new VetSatisfactionFormula());
      // Obtém a satisfação do funcionário e arredonda
      int satisfaction = Math.round(employee.getSatisfaction());
