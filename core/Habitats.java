...
public class Habitats implements Serializable,Responsibility {
    ...
    public int getWork() {
        int trabalho = _habitatArea; // Área do habitat
        trabalho += 3 * getNumAnimals(); // Triplo da população

        // Soma do esforço de limpeza de cada árvore no habitat
        for (Arvore arvore : _arvores.values()) {
            trabalho += arvore.getDificuldadeLimpeza(); // Método para obter o esforço de limpeza de cada árvore
        }
