  ...
  protected final void execute() {
    ...
    try {
      ...
      if (_receiver.getHotel().getFilename() == null) {
        ...
        // Adiciona uma linha de feedback ao usuário
        _display.addLine("Ficheiro sem nome. Guardar ficheiro como: " + filename);
        _display.display(); // Exibe a mensagem antes de salvar
